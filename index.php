...
<body>
	...
	<p>Вывод:<br/><br/><!--<pre style="white-space:pre-wrap;">--><textarea name="output" rows="15" cols="130"><?php
	if (isset($_POST["text"])) {
		$t = $_POST["text"];
		//$t = addslashes($t);
		//$t = oformlenie($t);
