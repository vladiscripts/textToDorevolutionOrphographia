...
from vladi_commons.vladi_helpers import file_readlines
...
if __name__ == '__main__':
    toDO = toDO.ToDO()
    listpages = set(file_readlines(listpages_filename))
    for title_do in listpages:
        ...
        # Конвертинг
        page_do.text = toDO.section_to_do(text_so_with_sections)
